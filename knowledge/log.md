...
- `data-model/page-node.md`: `PageNode.boxShadow?` 필드, PropSchema control에 `"icon"` 추가.
- `store/editor-store.md`: `setNodeShadow`·`centerInParent` 액션, `findParentChild`/`sameParent` 헬퍼와 AlignToolbar 연동 설명.
