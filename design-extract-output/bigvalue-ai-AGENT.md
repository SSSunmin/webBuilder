# You are building UI in the bigvalue.ai design system.

Source: https://www.bigvalue.ai/
Extracted by designlang on 2026-06-17.

## Brand at a glance

- title         데이터로 판단의 기준을 만듭니다 - Homepage | BigValue
- page intent   landing
...
- secondary   #4434e2
- accent      #dcdbfd
- neutrals    #e7e5e4 · #0c0a09 · #ffffff · #000000 · #25252f · #3f3f49

## Typography

- families   Pretendard Variable
- weights    400 · 600 · 500 · 700 · 800
- base size  16px

## Spacing

- scale      1px · 48px · 56px · 73px · 80px · 100px · 120px · 148px · 200px · 223px · 240px
...
Generated by designlang. Re-extract by running `npx designlang bigvalue.ai`.
