...
// 2026-06-17T07:01:05.527Z
//
// Zero-dependency. Runs on the browser-native Element.animate().
//   import { animations } from './bigvalue.ai-motion.waapi.js';
...
export const easings = {
  custom1: 'cubic-bezier(0.4, 0, 0.2, 1)', // 79× on page
  easeOut: 'cubic-bezier(0, 0, 0.2, 1)', // 4× on page
};
...
export const keyframes = {
  scroll: [{"transform":"translate(0px)","offset":0},{"transform":"translate(-100%)","offset":1}],
  scrollReverse: [{"transform":"translate(-100%)","offset":0},{"transform":"translate(0px)","offset":1}],
};
